...
ActiveRecord::Schema.define(version: 20_180_227_045_848) do
  ...
  create_table 'hashtagstweets', force: :cascade do |t|
    ...
    t.index %w[tweet_id hashtag_id], name: 'index_hashtagstweets_on_tweet_id_and_hashtag_id', unique: true
  ...
  create_table 'replies', force: :cascade do |t|
    ...
    t.index %w[user_id tweet_id], name: 'index_replies_on_user_id_and_tweet_id'
